...
export default function ActivityDetailClient({ activity, products, slug }: ActivityDetailClientProps) {
    ...
    return (
      <main className="relative w-full min-h-screen pb-16">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <CinemaWizard products={products} activityColor={activity.color} />
        </div>
      </main>
    );
  }
